...
class Evaluator:
    ...
    def __init__(self, 
        ...
        self.model_object = self.experiment.get_base_model_version()
    ...
    def _check_model_file_sanity(self,) -> None:
        try:
            ...
            raise ResourceNotFoundError(f"Can't run a evaluation job with this model, expected a 'model-latest' artifact")
